...
[Live Demo](https://gamerack.up.railway.app/)
...
| -------------- | ------------------------------------------------------------ | -------- |
| `SECRET_KEY`   | Any random string, used by Flask to sign session cookies     | Yes      |
| `DATABASE_URL` | Your PostgreSQL connection string                            | Yes      |
| `RAWG_API_KEY` | Get yours free at [rawg.io/apidocs](https://rawg.io/apidocs) | Yes      |
...
- [ ] **Responsiveness** — the app is designed for desktop browsers and has not been optimised for mobile or tablet viewports. A responsive layout using CSS media queries would be a good addition in the future.
